defmodule Quizaar.Schema.ResultTest do
  ...
  describe "fields and types" do
    test "it has the correct field and types" do
      actual_fields_with_types =
        for field <- Result.__schema__(:fields) do
          type = Result.__schema__(:type, field)
          {field, type}
        end
  ...
  describe "changeset/2" do
    ...
    test "error: returns an error changeset when given un-castable values" do
      ...
      assert %Ecto.Changeset{valid?: false, errors: errors} = Result.changeset(%Result{}, invalid_params)
